...
app.post('/orgaccess', proxy(
    {
      ...
      onProxyRes: (proxyRes, req, res) => {
        ...
        // modify response before it goes back
        modifyResponse(res, proxyRes, body => {
          if ( body ) {
            ...
            redactables.forEach( r => {
              if ( modified.data.requestAccessToOrg.accessRequest[r] ) {
                modified.data.requestAccessToOrg.accessRequest[r] = `[redacted]`;
              }
            });
